...
HD_PWD='C:/Users/Student/Desktop/Proiect/Proiect/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fading_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fading_led.tcl -notrace
