...
HD_PWD='C:/Users/Student/Desktop/Proiect/Proiect/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fading_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fading_led.tcl
